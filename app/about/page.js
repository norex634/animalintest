        ...
        <div className="flex flex-col px-[15%] gap-6 ">
            <div className="flex flex-col h-full gap-6 border-t-[10px] border-[#25CAAC] ">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    <Image className="min-w-[40%] min-h-[30%]" src="https://ds.static.rtbf.be/article/image/770x770/7/f/8/ec93ca97659bfc5d22285fad975f26af-1642412505.jpg" width={500} height={100}></Image>
