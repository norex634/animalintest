            ...
            <div className="flex flex-col h-full gap-6 border-t-[10px] border-[#25CAAC] ">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex flex-col gap-4 lg:text-[1.5em] md:text-[1.2em]">
                        ...
                        <p>
                            Chaque année, ce sont plus de <span className="text-[#25CAAC] underline decoration-[#25CAAC]">1 800 animaux</span> qui sont sauvés par le refuge et plus d&apos;une dizaine d&apos;événements ou de campagnes qui sont réalisés. Le refuge héberge et soigne en permanence environ 300 chiens et chats. Notre association possède un réseau de membres de plus de 3 500 personnes et ne perçoit aucune subvention pour sa gestion quotidienne. Son budget annuel dépasse 800 000 euros.
                        </p>
                        <p>
