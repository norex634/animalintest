...
import { PostRace } from "@/utils/fetch/Race"
...
export function DataTable({
  ...
  // État local pour les champs de nom
  const [nom, setNom] = React.useState("Titre de la race");
        ...
        <div className="p-2 bg">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle>Nouvelles race</DialogTitle>
              </DialogHeader>
